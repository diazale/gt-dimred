...
\begin{figure*}
    ...
    \end{subfigure}
    \caption{Figure~\ref{fig:umap_world_map}, zoomed in on Asia. \sgcomment{add caption from fig5b? No cost to being self-contained here. }}
...
\begin{figure*}
    ...
    \end{subfigure}
    \caption{Figure~\ref{fig:umap_world_map}, zoomed in on the Caribbean. \sgcomment{add caption from fig5b? No cost to being self-contained here. }}
...
\begin{figure*}
    ...
    \end{subfigure}
    \caption{Figure~\ref{fig:umap_world_map}, zoomed in on Europe. \sgcomment{add caption from fig5b? No cost to being self-contained here. }}
