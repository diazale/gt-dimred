...
\\
\\
Results: Using genotype data from the 1000 Genomes Project, the Health and Retirement Study, and the UK Biobank, we demonstrate that PCA-UMAP effectively clusters individuals who are genetically closely related while placing them in a global continuum of genetic variation. This dimension reduction approach reveals subpopulations within the American Hispanic population, fine-scale relationships between geography and genotype in the UK population, and rich phenotypic variation across space and ethnicity in the UK Biobank. 
\\
\\
